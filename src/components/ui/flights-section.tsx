      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Найдите лучшие предложения на авиабилеты из России во Вьетнам
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <Button
                ...
                className={tripType === "roundtrip" ? "bg-gradient-ocean text-white" : ""}
              >
              ...
              <Button
                ...
                className={tripType === "oneway" ? "bg-gradient-ocean text-white" : ""}
              >
