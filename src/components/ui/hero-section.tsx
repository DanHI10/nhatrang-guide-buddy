      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 drop-shadow-lg">
            Добро пожаловать 
            <span className="block text-secondary">в Нячанг</span>
          </h1>
          ...
          <Card className="p-6 mb-8 bg-card/95 backdrop-blur border-0 shadow-elevated">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                <Input 
                  placeholder="Найти экскурсии, рестораны, развлечения..."
                  className="h-12 text-lg border-0 bg-muted/50 focus:bg-muted"
                />
              </div>
